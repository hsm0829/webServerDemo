...
//     * @param result
//     */
//    @AfterReturning(value = "execution(* com.web.generator.aop.ArithmeticCalculatorI.*(..))" , returning = "result")
...
//     * @param e
//     */
//    @AfterThrowing(value = "execution(* com.web.generator.aop.ArithmeticCalculatorI.*(..))",throwing = "e")
...
//    }
     ...
     * @return
     */
    @Around("execution(* com.web.generator.aop.ArithmeticCalculatorI.*(..))")
